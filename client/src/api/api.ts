...
const localApi = axios.create({
  ...
  timeout: 2000, // 2 second default timeout
  ...
  transformResponse: [
    (data) => {
      ...
      try {
        ...
        // Response was not JSON (e.g. HTML error page). Return raw data so
        // callers can handle it instead of throwing a parse error.
        return data;
      }
    },
  ]
